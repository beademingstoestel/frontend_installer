...
printjson(db.getSiblingDB("beademing").createCollection("targetpressure_values"));
...
printjson(db.getSiblingDB("beademing").targetpressure_values.createIndex( { loggedAt: -1 } ));
